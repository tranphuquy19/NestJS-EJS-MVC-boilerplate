export const IMAGE_REGEX = /\.(jpg|jpeg|png|gif|bmp|webp)$/i;
export const VIDEO_REGEX = /\.(mp4|webm|ogg|ogv|mov|m4v|avi|wmv|mpg|mpeg|3gp)$/i;
export const AUDIO_REGEX = /\.(mp3|m4a|ogg|wav|flac|aac)$/i;
